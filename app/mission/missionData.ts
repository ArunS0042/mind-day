...
export const MISSION_POOL: Record<string, ExerciseCategory> = {
	memory_digit: {
		...
		questions: [
			{
				memorizeText: "จำตัวเลข: 3 - 8 - 5",
				questionText: "ตัวเลขตัวสุดท้ายคืออะไร?",
				options: ["3", "5", "8", "9"],
				correct: "5",
			},
			{
				memorizeText: "จำตัวเลข: 7 - 2 - 9 - 4 - 1",
				questionText: "ตัวเลขตัวที่ 3 คืออะไร?",
				options: ["2", "4", "9", "1"],
				correct: "9",
			},
			{
				memorizeText: "จำตัวเลข: 4 - 7 - 2 - 9",
				questionText: "ข้อใดเรียงลำดับตัวเลขย้อนกลับจากหลังมาหน้าได้ถูกต้อง?",
				options: [
					"9 - 2 - 7 - 4",
					"4 - 7 - 2 - 9",
					"9 - 4 - 2 - 7",
			...
			{
				memorizeText: "จำตัวเลข: 1 - 6 - 8",
				questionText: "ตัวเลขตัวแรกสุดคืออะไร?",
				options: ["1", "6", "8", "0"],
				correct: "1",
			},
			{
				memorizeText: "จำตัวเลข: 5 - 3 - 9 - 2",
				questionText: "มีเลข 3 อยู่ในตำแหน่งที่เท่าไหร่หากนับจากซ้ายมือ?",
	...
	memory_story: {
		...
		questions: [
			{
				memorizeText:
					'อ่านและจดจำเรื่องราวสั้น ๆ:\n"เมื่อเช้านี้ ป้าสมศรีเดินไปตลาดเพื่อซื้อปลาทู 2 ตัว และมะนาว 3 ลูก"',
				questionText: "จากเรื่องราวข้างต้น ป้าสมศรีเดินไปซื้ออะไรที่ตลาด?",
			...
			},
			{
				memorizeText:
					'อ่านและจดจำเรื่องราวสั้น ๆ:\n"เมื่อเช้านี้ ป้าสมศรีเดินไปตลาดเพื่อซื้อปลาทู 2 ตัว และมะนาว 3 ลูก"',
				questionText:
					"จากเรื่องราวข้างต้น ป้าสมศรีซื้อปลาทูมาทั้งหมดจำนวนกี่ตัว?",
				options: ["1 ตัว", "2 ตัว", "3 ตัว", "4 ตัว"],
				correct: "2 ตัว",
			},
			{
				memorizeText:
					'อ่านและจดจำเรื่องราวสั้น ๆ:\n"คุณลุงชาลีเลี้ยงสุนัขสีดำชื่อ โกโก้ มันชอบวิ่งเล่นในสวนตอนบ่ายโมง"',
				questionText: "สุนัขแสนรู้ของคุณลุงชาลีมีชื่อเรียกว่าอะไร?",
			...
			},
			{
				memorizeText:
					'อ่านและจดจำเรื่องราวสั้น ๆ:\n"คุณลุงชาลีเลี้ยงสุนัขสีดำชื่อ โกโก้ มันชอบวิ่งเล่นในสวนตอนบ่ายโมง"',
				questionText: "สุนัขตัวนี้ชอบออกไปวิ่งเล่นในสวน ณ เวลาใด?",
				options: ["ตอนเช้าตรู่", "ตอนเที่ยงวัน", "ตอนบ่ายโมง", "ตอนเย็น"],
				correct: "ตอนบ่ายโมง",
			},
			{
				memorizeText:
					'อ่านและจดจำเรื่องราวสั้น ๆ:\n"น้องแก้วลืมร่มสีฟ้าไว้ที่โรงเรียนเมื่อวันศุกร์ ทำให้วันเสาร์เธอต้องเดินตากฝน"',
				questionText:
					"จากเรื่องราวข้างต้น น้องแก้วลืมร่มส่วนตัวทิ้งไว้ที่สถานที่ใด?",
	...
	attention: {
		...
		questions: [
			...
			},
			{
				...
				options: ["ตื่นนอน", "กินข้าว", "เดินเล่น", "อาบน้ำ"],
				correct: "อาบน้ำ",
			},
			{
	...
	language: {
		...
		questions: [
			...
			},
			{
				...
				options: ["ป่า", "ดง", "พงไพร", "ภูเขา"],
				correct: "ภูเขา", 
			},
			{
				question: "คำใดมีความหมายเหมือนกับคำว่า 'บ้าน'?",
				options: ["อาคาร", "เรือน", "ถนน", "สนาม"],
				correct: "เรือน",
			},
		],
	},
